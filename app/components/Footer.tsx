    ...
    <footer className="bg-[#333333] text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li><a href="#blog" className="text-gray-300 hover:text-[#00C851] transition-colors">Blog</a></li> */}
          ...
          {/* Contacto y redes */}
          <div>
            <h3 className="font-semibold mb-4 text-[#00C851]">Síguenos</h3>
            <div className="flex space-x-4 mb-4">
              <a href="#" className="text-gray-300 hover:text-[#00C851] transition-colors">
            ...
            <div className="space-y-2">
              <a href="https://wa.me/" className="flex items-center space-x-2 text-gray-300 hover:text-[#00C851] transition-colors">
        ...
        <div className="border-t border-gray-600 mt-12 pt-8 text-center">
          <p className="text-gray-400">© AgroSensIA 2025 – Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
