  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="group flex items-center bg-[#25D366] hover:bg-[#128C7E] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110"
      >
        ...
        <span className="hidden sm:block font-medium">¡Chatea con nosotros!</span>
